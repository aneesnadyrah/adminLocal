...
window.onload = function () {
  ...
  if (typeof appTitle !== "undefined") {
    // appsappTitle variable exists
    if (appTitle.toUpperCase() == "UCIDOS") {
      mapCenterInit = [103.326, 3.8077];
    } else if (appTitle.toUpperCase() == "KITER") {
      mapCenterInit = [103.14608033896808, 5.328777955715676];
    } else if (appTitle.toUpperCase() == "KUDRAT") {
      mapCenterInit = [101.0914411, 4.6002637];
    } else {
      mapCenterInit = [103.326, 3.8077];
    }
  } else {
    // appsappTitle variable does not exist
    mapCenterInit = [103.326, 3.8077];
  }

  mapboxgl.accessToken =
    "pk.eyJ1IjoibXJoNHMiLCJhIjoiY2poeDh3bmtoMDk5ZTNrcDhkaDBnamFiMiJ9.G-NU8f4IrxF2vr7X43lE0w";
  ...
  map.on("load", function () {
    ...
    // mapContainer.style.borderRadius = "25px";
  });

  const markers = [
    [103.326, 3.8077, "assets/media/avatars/300-1.jpg", "Aliff"],
    [103.226, 3.7077, "assets/media/avatars/300-2.jpg", "Atikah"],
    [103.226, 3.9077, "assets/media/avatars/300-3.jpg", "Najmie"],
  ];
