...
// Class definition
var ReviewUDM = (function () {
  var initializeReviewUDM = function () {
    var elements = [].slice.call(
      document.querySelectorAll("[data-review-udm]")
    );

    elements.map(function (items) {
      var systemId = items.getAttribute("data-system-id");
      var Id = items.getAttribute("data-id");
      let submitId = "#submit-confirm-review-udm-" + Id;
      let submitButton = items.querySelector(submitId);
      let submitId2 = "#submit-no-review-udm-" + Id;
      let submitButton2 = items.querySelector(submitId2);

      const form = items.querySelector("#form-review-udm-" + Id);
          ...
          if (status == "Valid") {
            ...
            api
              ...
              .then((response) => {
                ...
                toastr.success(
                  "Semakan Pelan Infrastruktur Utiliti Terima Berjaya Disimpan! 🎉"
                );
          ...
          if (status == "Valid") {
            ...
            api
              ...
              .then((response) => {
                ...
                // toastr.success(response.message);
                toastr.success(
                  "Semakan Pelan Infrastruktur Utiliti Berjaya Disimpan! 🎉"
                );
