...
var generalTable = (function () {
  ...
  var initTable = () => {
    return new Promise((resolve) => {
      ...
      dataTable.on("click", ".confirm-alert-btn", function () {
        ...
        Swal.fire({
          title: "Pengesahan Mula Kerja",
          text: "Adakah anda pasti mahu memulakan kerja ukur?",
          icon: "warning",
          ...
          if (result.isConfirmed) {
            // Show prompt to write notes using SweetAlert
            Swal.fire({
              title: "Catatan Mula Kerja Ukur",
              input: "textarea",
              inputPlaceholder: "Sila tulis catatan di sini...",
              icon: "info",
              showCancelButton: true,
              ...
              if (notesResult.isConfirmed) {
                ...
                api
                  .post(`surveys/priority/tasking`, jsonData)
                  .then((response) => {
                    toastr.options = {
                      closeButton: false,
                      debug: false,
                    ...
                    toastr.success("Nota berjaya dihantar! 🎉");

                    // Navigate to the new page after a successful API call
                    setTimeout(function () {
                      location.href = "surveys/priority/new";
                    }, 2500);
                  })
                  .catch((error) => {
  ...
  var handleFlatpickr = (selectedDates, dateStr, instance) => {
    ...
    $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
      ...
      var dateAdded = new Date(
        moment(data[1], "DD/MM/YYYY").format("YYYY-MM-DD")
      );
  ...
  var handleDropzone = () => {
    ...
    elements.map(function (element) {
      ...
      var submitId = "submit-" + systemId + "-" + statusId;
      var submitButton = document.querySelector(
        '[data-submit="' + submitId + '"]'
      );
  ...
  var handleSubmitTask = () => {
    ...
    submitButtons.map(function (submitButton) {
      ...
      var statusId = chunks[2];
      var systemId = chunks[1];
      var formId = "form-" + systemId + "-" + statusId;
