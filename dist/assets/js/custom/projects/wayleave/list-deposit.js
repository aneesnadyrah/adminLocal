...
var DepositList = (function () {
  ...
  var initDatatable = function () {
    ...
    datatable = $(table).DataTable({
      ajax: apps + "/api/wayleave/deposit/list",
      columns: [
        { data: "reference_no" },
        { data: "authority_name" },
        { data: "authority_district_name" },
        { data: "Length" },
        { data: "DepositStatus" },
        { data: "created_at" },
        { data: null },
        ...
        },
        {
          ...
          render: function (index, type, key, meta) {
            let render;
              ...
              <a href="projects/wayleave/deposit/`+ key['system_id'] +`?aid=` + key['flw_authority_id'] + `" class="btn btn-icon btn-light-` + key["DepositStatusColor"] + `">
                <i class="fad fa-` + key["DepositStatusIcon"] + ` fs-2"></i>
              </a>
            </div>`
  ...
  return {
    init: function () {
      table = document.querySelector("#list-deposit");
