"use strict";
if (document.getElementById('survey_action_form') === null) {
...
// });
    ...
    validator = FormValidation.formValidation(form, {
      fields: {
        "survey-assign": {
          validators: {
            notEmpty: {
              message: "Sila Pilih Kumpulan Survey",
            },
          },
        },
        "start-date": {
  ...
  var handleSurveyAssign = function (e) {
    // Handle form submit
    submitButton.addEventListener("click", function (e) {
      ...
      validator.validate().then(function (status) {
        if (status == "Valid") {
          ...
          $.ajax({
            url: "https://"+hostApps+"/v1/projects/survey-assign.php",
            type: "POST",
            ...
            success: function (response) {
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  window.location.href = "/survey/tasks/new.php";
                }
              });
            },
  ...
  return {
    // Initialization
    init: function () {
      form = document.querySelector("#survey_action_form");
      submitButton = document.querySelector("#survey_action_submit");
