...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        // include "components/tables/survey-priority-task.php" 
                        $Task->table('survey-priority-task');
                        ?>
                    </div>
                    <!--end::Container-->
                </div>
    ...
    <!--end::Javascript-->
    <script src="assets/js/custom/survey/priority-table/task.js"></script>
</body>
<!--end::Body-->
