...
$Task = new surveyFinance($username);
$filter = 'new';
...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php 
                        $Task->table('survey-finance-task');
                        ?>
                    </div>
                    <!--end::Container-->
                </div>
    ...
    <?php
    // $Task->modal('general-tasks', $filter, $phase);
    include 'components/partials/modals/survey-start-work.php';
    ?>
    <!--end::Modals-->
    <!--begin::Javascript-->
    ...
    <!-- <script src="assets/js/custom/utilities/modals/finance-uploadWO.js"></script> -->
    ...
    <!--end::Javascript-->
    <script async src="assets/js/custom/survey/start-work.js"></script>
</body>
<!--end::Body-->
