...
require_once "api/functions/survey.php";
...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on" class="page-loading-enabled page-loading header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        // if ($currentStatus == 104) {
                            if (in_array(104, array_column($currentStatus, 'status_id'))) {
                            include "components/forms/survey-asb-report-confirm.php";
                        } else {
                            include "components/forms/survey-asb-report-review.php";
                        }
                        ?>
                        <!--end::Row-->
                    </div>
    ...
    //     include $modal;
    // } ?>
    <?php include "components/partials/modals/amend-survey-report-asb.php"; ?>
    ...
    <script async src="assets/js/custom/survey/site/report-asb.js"></script>
    <script async src="assets/js/custom/survey/site/amend-report-asb.js"></script>
