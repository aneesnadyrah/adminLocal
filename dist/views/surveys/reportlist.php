...
$List = new SurveyReport($username);
?>
...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
    ...
    <script async src="assets/js/custom/survey/team/survey_report.js"></script>
    <!--end::Javascript-->
</body>
<!--end::Body-->
