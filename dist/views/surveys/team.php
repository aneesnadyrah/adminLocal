...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
    ...
    <?php include General::getModal("survey-team") ?>
    <?php include General::getModal("survey-add-team") ?>
    ...
    <script async src="assets/js/custom/survey/team/team2.js"></script>
    <script async src="assets/js/custom/survey/team/add.js"></script>
