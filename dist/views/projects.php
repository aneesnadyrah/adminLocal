...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php
                            if ($systemId != NULL) {
                                $Project = new Project($username);
                                $Project->table('project-tasks',$systemId);
                            }
                            elseif ($phase != NULL) {
                                $Project = new ProjectActive($username);
                                $Project->table('project-active-phase',$phase);
                            }
                        ?>
                    </div>
                    <!--end::Container-->
    ...
    <!--begin::Modals-->
        <?php
        if ($systemId != NULL) {
            $Project->modal('project-site-visit-date-approval',$systemId);
        }
        else if ($phase != NULL) {
            $Project->modal('project-active-phase',$phase);
        }
        ?>
    <!--end::Modals-->
    <!--begin::Javascript-->
    ...
    <!--begin::Custom Javascript(used for this page only)-->
        <?php
        if ($systemId != NULL) {
            echo '<script src="assets/js/custom/tasks/sitevisit.js"></script>';
        }
        else if ($phase != NULL) {
            echo '<script src="assets/js/custom/tasks/active-phase.js"></script>';
        }
        ?>
