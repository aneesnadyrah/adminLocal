...
<head>
    ...
    <link href="assets/css/custom/reports/summary.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php include "components/views/site-report-review.php" ?>
                    </div>
                    <!--end::Container-->
                </div>
                <!--end::Content-->
    ...
    <?php // foreach ($actionModals as $modal) { include $modal;}  ?>
    <?php // foreach ($taskModals as $modal) { include $modal; }  ?>
    <?php include "components/partials/modals/approve-report.php"; ?>
    ...
    <script>
        ...
        var reportData = <?php echo json_encode($currentReport); ?>;
        var reportRef = '<?php echo $reportId; ?>';
        var reportCtrl = <?php echo $reportCtrl; ?>;
    </script>
    ...
    <script src="assets/js/custom/reports/review.js"></script>
    <!--end::Javascript-->
</body>
<!--end::Body-->
