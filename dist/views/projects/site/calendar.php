...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					<div class="container-xxl" id="kt_content_container">
						<?php include "apps/calendar/calendar.php" ?>
					</div>
				</div>
                <!--end::Content-->
				<!--end::Content-->
	...
	<script src="assets/js/custom/pages/projects/calendar/sv-calendar.js"></script>
