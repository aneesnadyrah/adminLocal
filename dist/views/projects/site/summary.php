...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php include "components/wizards/site-summary.php" ?>
                    </div>
                    <!--end::Container-->
                </div>
                <!--end::Content-->
    ...
    <?php include "components/partials/modals/amend-details-select.php"; ?>
    ...
    <script src="assets/js/custom/reports/summary.js"></script>
