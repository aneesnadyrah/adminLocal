...
class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php include "components/tables/report-list.php" ?>
                    </div>
                    <!--end::Container-->
                </div>
                <!--end::Content-->
    ...
    <script>
        var hostUrl = "assets/";
        var refNo = "<?php echo General::getReferenceNo($PDO, isset($_GET['sid']) ? $_GET['sid'] : ''); ?>";
    </script>
    ...
    <script async src="assets/js/custom/projects/list/site-report.js"></script>
