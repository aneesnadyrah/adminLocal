...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        <?php
                        // include "components/tables/survey-team.php" 
                        $Task->table('ppkd-team')
                            ?>
    ...
    <!--begin::Modals-->
    <?php include General::getModal("ppkd-team") ?>
    <?php include General::getModal("ppkd-add-team") ?>
    <!--end::Modals-->
    ...
    <script async src="assets/js/custom/projects/team/team.js"></script>
    <script async src="assets/js/custom/projects/team/add.js"></script>
