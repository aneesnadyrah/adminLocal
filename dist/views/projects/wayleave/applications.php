...
<body id="kt_body" style="background-image: url()" data-kt-aside-minimize="on"
    ...
    <script src="assets/js/custom/projects/record/application-entry.js"></script>
    <?php if($roleId == 1): ?>
    <script src="assets/js/custom/projects/record/application-entry-edit.js"></script>
    <?php endif ?>
