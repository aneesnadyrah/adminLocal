...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url()" class="page-bg-image-lg header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
											...
											<div class="m-0">
												...
												<div class="d-flex mb-10">
																...
																<div data-kt-search-element="results" class="d-none">
																	...
																	<div class="scroll-y mh-200px mh-lg-350px">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="assets/media/brand-logos/volicity-9.svg" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="assets/media/d-logos/tvit.svg" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="assets/media/misc/infography.svg" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="assets/media/brand-logos/leaf.svg" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="assets/media/brand-logos/tower.svg" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
													...
													<div class="flex-shrink-0 ms-2">
														...
														<!--begin::Menu-->
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63de80d132037">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63de80d132037" data-allow-clear="true">
																			<option></option>
												...
												<div class="m-0">
													...
													<div class="mb-10">
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/balloon.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/infography.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/disqus.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="assets/media/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion mb-1">
																...
																<div class="menu-sub menu-sub-accordion">
																	...
																	<div class="menu-item">
																		<!--begin:Menu link-->
																		<a class="menu-link active" href="../../demo7/dist/apps/support-center/tickets/list.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="text-dark fw-bold my-0 fs-2">Tickets List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
									...
									<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
										...
										<ul class="nav flex-wrap border-transparent fw-bold">
											...
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo7/dist/apps/support-center/overview.html">Overview</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="../../demo7/dist/apps/support-center/tickets/list.html">tickets</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo7/dist/apps/support-center/tutorials/list.html">Tutorials</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo7/dist/apps/support-center/faq.html">FAQ</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo7/dist/apps/support-center/licenses.html">Licenses</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item my-1">
												<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo7/dist/apps/support-center/contact.html">Contact US</a>
											</li>
											<!--end::Nav item-->
										</ul>
										<!--end::Nav-->
												...
												<div class="mb-10">
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">How to use Netronic with Django Framework?</a>
																<!--end::Title-->
																<!--begin::Label-->
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme npm issue</a>
																<!--end::Title-->
																<!--begin::Label-->
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme authentication to node.js / strapi backend</a>
																<!--end::Title-->
																<!--begin::Label-->
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">How to use Admin theme with Django Framework?</a>
																<!--end::Title-->
																<!--begin::Label-->
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Reducing footprint of Start theme</a>
																<!--end::Title-->
																<!--begin::Label-->
																<span class="badge badge-light my-1">Angular</span>
																<!--end::Label-->
													...
													<div class="d-flex mb-10">
														...
														<div class="d-flex flex-column">
															...
															<div class="d-flex align-items-center mb-2">
																<!--begin::Title-->
																<a href="../../demo7/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme node.js / strapi backend</a>
																<!--end::Title-->
																<!--begin::Label-->
																<span class="badge badge-light my-1">React</span>
																<!--end::Label-->
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo7/dist/apps/projects/project.html" class="w-30px me-3" src="assets/media/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo7/dist/apps/projects/project.html" class="w-30px me-3" src="assets/media/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="assets/media/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="assets/media/card-logos/visa.svg" alt="" class="h-25px" />
														<img src="assets/media/card-logos/mastercard.svg" alt="" class="h-25px" />
														<img src="assets/media/card-logos/american-express.svg" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
