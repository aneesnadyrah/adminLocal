		...
		// foreach($authorityIdsArray as $row){
			...
			if ($appsTitle == 'UCIDOS'){
                ...
                $letterDateTable3 = '<div class="fw-row mb-5 d-flex flex-center">
                    <div class="d-flex justify-content-center w-400px">
                        <table class="table table-bordered lh-sm" style="border: 1px solid white;">
                            <tbody>
                                <tr>
                                <td scope="row" class="text-start p-1 fs-5">(i)</td>
                                <td class="p-1 ps-3 fs-5">Pelan cadangan laluan utiliti</td>
                                </tr>
                                <tr>
                                <td scope="row" class="text-start p-1 fs-5">(ii)</td>
                                <td class="p-1 ps-3 fs-5">Kaedah pemasangan utiliti</td>
                                </tr>
                                <tr>
                                <td scope="row" class="text-start p-1 fs-5">(iii)</td>
                                <td class="p-1 ps-3 fs-5">Gambar-gambar lokasi</td>
                                </tr>
                                <tr>
                                <td scope="row" class="text-start p-1 fs-5">(iv)</td>
                                <td class="p-1 ps-3 fs-5">Tarikh jangka mula pada <b>' . General::convertDate($generateInfo['date_start']) . '</b> dan <br> jangka siap pada <b>' . General::convertDate($generateInfo['date_finish']) . '</b></td>
                                </tr>
                                '.$pointV.'
                                <tr>
                                <td scope="row" class="text-start p-1 fs-5">(vi)</td>
                                <td class="p-1 ps-3 fs-5">Borang laporan lawatan tapak</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
			...
			<div class="card mb-5 print-content-only" >
				...
				<div class="card-body py-12 px-20" >
					<!--begin::Form-->
					<form action="" id="form-PIL-review-'.$modalId.'" >
						<div class="section-1">
							<!--begin::Wrapper-->
						...
						<div class="section-2">
								<div class="row gb-20 mb-5">
									...
									<span class="fs-5 mb-5 lh-sm" style="text-align: justify;">'.$endingLine.'</span>
...
?>
	...
	<div class="flex-lg-auto min-w-lg-300px">
		...
		if(Permitting::letterStatus($letterNo)[0]['letter_status'] == '1'){
			...
			<div class="card-body p-10">
				<!--begin::Actions-->
				<div class="mb-0">
					<button type="submit" href="#" class="btn btn-light-primary btn-active-primary w-100 mb-6" id="send-button-'.$modalId.'">
					...
					<button type="button" class="btn btn-light btn-active-primary w-100" id="edit_button"  data-bs-toggle="modal" data-bs-target="#update-letter-'.$modalId.'">
						<span class="svg-icon svg-icon-3">
        ...
        echo '<div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: \'200px\'}" data-kt-sticky-width="{lg: \'250px\', lg: \'300px\'}" data-kt-sticky-left="auto" data-kt-sticky-top="75px" data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
                                ...
                                <div class="card-body p-10">
                                    <!--begin::Actions-->
                                    <div class="mb-0">
                                    <a href="letters/list" class="btn btn-light-primary btn-active-primary w-100 mb-6">
                                    <span class="svg-icon svg-icon-3">
                                        <i class="fad fa-file-circle-check fs-2"></i>
                                    </span>
		...
		}else if(Permitting::letterStatus($letterNo)[0]['letter_status'] == '2'){
			...
			<div class="card-body p-10">
				<!--begin::Actions-->
				<div class="mb-0">
					<button type="submit" href="#" class="btn btn-light-primary btn-active-primary w-100 mb-6" id="approve-button-'.$modalId.'">
						<span class="svg-icon svg-icon-3">
							<i class="fad fa-file-circle-check fs-2"></i>
						</span>
					...
					<button type="button" class="btn btn-light btn-active-primary w-100" id="comment_button"  data-bs-toggle="modal" data-bs-target="#comment-'.$modalId.'">
						<span class="svg-icon svg-icon-3">
							<i class="fad fa-file-pen fs-2"></i>
						</span>Pinda Surat
					</button>
        ...
        echo '<div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: \'200px\'}" data-kt-sticky-width="{lg: \'250px\', lg: \'300px\'}" data-kt-sticky-left="auto" data-kt-sticky-top="75px" data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
		...
		} else if(Permitting::letterStatus($letterNo)[0]['letter_status'] == '3'){
			echo '
			<div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: \'200px\'}" data-kt-sticky-width="{lg: \'250px\', lg: \'300px\'}" data-kt-sticky-left="auto" data-kt-sticky-top="75px" data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
			<!--begin::Card body-->
			<div class="card-body p-10 d-print-none">
				<!--begin::Actions-->
				<div class="mb-0">
					<button type="submit" href="#" class="btn btn-light-primary btn-active-primary w-100 mb-6"  onclick="window.location.href=`/projects/prints/PKIL/'.$systemId.'?lid='.$letterId.'`" data-kt-scrolltop="true">
						<span class="svg-icon svg-icon-3">
							<i class="fad fa-file-circle-check fs-2"></i>
						</span>
						<span class="indicator-label">Cetak Surat</span>
						<span class="indicator-progress">Sila Tunggu...
							<span class="spinner-border spinner-border-sm align-middle ms-2"></span>
						</span>
					</button>
		...
		} else if(Permitting::letterStatus($letterNo)[0]['letter_status'] == '4'){
			...
			<div class="card-body p-10">
				...
				<div class="mb-5">
					<div class="d-flex flex-column">
						...
						<!--end::Label-->
						<div class="fv-row">
							<span type="text" class="fs-6 text-gray-800" placeholder="Catatan..." name="letter-comment">'.$generateInfo['letter_comment'].'</span>
						</div>
					</div>
				</div>
