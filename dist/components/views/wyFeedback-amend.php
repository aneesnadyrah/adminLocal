...
$data_wy = Wayleave::getGenerateWyFeedback($sysID, 3); 
?>
        ...
        <div class="card mb-8">
            ...
            <div class="card-body p-12">
                ...
                <div class="mb-5">
                    ...
                    <div class="flex-column current" data-kt-stepper-element="content">
                        ...
                        <div class="d-flex flex-row align-items-center flex-xxl-row">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bold my-0 fs-2 me-auto">Pindaan Surat Maklum Balas Izin Lalu</h1>
                            <!--end::Title-->
                            ...
                            <i class="fad fa-print fs-4"></i>Cetak</button>
                            <!-- end::print-->
                        </div>
                        <!--end::Title-->
                        <!--begin::Separator-->
                            ...
                            <?php 
                                ...
                                if($appsTitle == 'UCIDOS') {
                                    foreach ($data_wy as $data) {
                                        ...
                                        $wyFeedbackId = $data['WyFeedbackID'];

                                        echo' 
                                        <!--begin::Notes-->
                                        <div class="accordion accordion-icon-collapse d-print-none" id="kt_accordion_3">
                                            <!--begin::Item-->
                                            <div class="mb-5">
                                                <!--begin::Header-->
                                                <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse" data-bs-target="#kt_accordion_3_item_2">
                                                    <span class="accordion-icon">
                                                        <i class="fad fa-plus-square fs-3 accordion-icon-off"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                        <i class="fad fa-minus-square fs-3 accordion-icon-on"><span class="path1"></span><span class="path2"></span></i>
                                                    </span>
                                                    <h3 class="fs-4 fw-semibold mb-0 ms-4 text-danger">Catatan Daripada <b>'.$data['staffApprovePosition'].'</b></h3>
                                                </div>
                                                <!--end::Header-->

                                                <!--begin::Body-->
                                                <div id="kt_accordion_3_item_2" class="collapse fs-6 ps-10 d-print-none" data-bs-parent="#kt_accordion_3">
                                                    <span class="fs-5 mb-20 text-danger">'.$data['Notes'].'</span>
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                            <!--end::Item-->
                                        ...
                                        foreach ($providerData as $row2) {
                                            ...
                                            echo '<span class="fs-5"><b>(u.p.:' . $data['ProviderUP'] . ')</b></span>';
                                            echo '</div>';
                                        }
                                        ...
                                        <input type="text" name="system-id" value="'.$data['SysID'].'" hidden>
                                        <input type="text" name="ltr-ref-no" value="'.$data['LtrRefNo'].'" hidden>
                                        <input type="text" name="ltr-wyFeedback-id" value="'.$data['WyFeedbackID'].'" hidden>
                                        ';
                                    }
                ...
                <form action="" id="form_wayFeedback_generate" >
                    <input type="text" name="item" value="send-wyFeedback-approval-amend" hidden>
                    <input type="text" name="system-id" value="<?php echo $sysID ?>" hidden>
                    <input type="text" name="wyFeedback-id" value="<?php echo $wyFeedbackId ?>" hidden>
