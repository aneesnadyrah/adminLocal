...
<form id="add_progress" class="form d-flex flex-column flex-lg-row">
    <input type="text" name="progress-asb" value="1" hidden />
        ...
        <div class="card card-flush py-4">
            ...
            <div class="d-flex align-items-center w-300px w-sm-260px flex-column ms-10">
                <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                    <span class="fw-semibold fs-6 text-gray-600">Progress Jarak <?php echo $c ?> / <?php echo $p[0]['Length']; ?></span>
                    <span class="fw-bold fs-6"><?php echo round(($c / $p[0]['Length']) * 100); ?>%</span>
                </div>
                <div class="progress-bar-container">
                    <div class="progress-bar" style="width: <?php echo round(($c / $p[0]['Length']) * 100); ?>%;" aria-valuenow="<?php echo round(($c / $p[0]['Length']) * 100); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        <div class="col mb-2 fv-row">
                            ...
                            <input type="text" name="daily-progress" class="form-control" placeholder="Jarak Harian" value="0" />
                        </div>
                        <div class="col mb-2 fv-row">
                    ...
                    <div class="row">
                        <div class="col mb-10 fv-row">
                            ...
                            <input type="text" name="pegging-distance" class="form-control" placeholder="Jarak Menambat" value="0" />
                        </div>
                        <div class="col mb-10 fv-row">
                            <label class="required form-label">Jarak Pengesanan (Detection)</label>
                            <input type="text" name="detection-distance" class="form-control" placeholder="Jarak Pengesanan" value="0" />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
