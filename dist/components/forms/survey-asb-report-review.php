...
<div class="d-flex flex-column flex-lg-row">
    ...
    <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
        ...
        <div class="card">
            ...
            <div class="card-body py-12 px-20">
                ...
                $d = Survey::surveyLogBookAsb($systemId);
                $members = Survey::surveyMembersAsb($systemId);
                $surveyImageData = Survey::getSurveyImageDataAsb($systemId);
                // var_dump($surveyImageData);
                $surveyLength = $surveyApi->getSurveyLengthAsb($systemId);
                $start = Survey::getStartCoordinatesAsb($systemId);
                $end = Survey::getEndCoordinatesAsb($systemId);

                $dateRange = Survey::getStartAndEndDatesAsb($systemId);

                // Access the earliest and latest dates
                $earliestDate = $dateRange['earliest_date'];
                $latestDate = $dateRange['latest_date'];

                $categoryData = Survey::getCategoryReportsAsb($systemId);
                $surveyWorkData = Survey::getAllSurveyWorkDataAsb($systemId);
                $equipmentData = Survey::getAllEquipmentDataAsb($systemId);

                $reportUpdate = Survey::getUpdateDataReportAsb($systemId);
                ...
                <form action="" id="form-report-review" class="print-content-only">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="d-flex flex-column align-items-start flex-xxl-row mt-10 mb-20 ms-10 me-5">
                            <!--begin::Input group-->
                            <div
                                class="d-flex align-items-center justify-content-start flex-equal order-3 fw-row mt-10 ms-10">
                                <!--begin::Input-->
                                ...
                                <div class="position-relative d-flex align-items-center w-200px me-10">
                                    <img class="mw-150px"
                                        src="<?php echo General::getProvider($p[0]['ProviderID'])->logo; ?>" />
                                </div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                                ...
                                for ($i = 0; $i < $rowCount; $i += 2):
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        ...
                                                        <img class="image-fit" src="<?php echo $imageData1['url']; ?>"
                                                            alt="image"
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        style="height: 300px; width: 300px;">
                                                        <?php if ($imageData2): ?>
                                                            <img class="image-fit" src="<?php echo $imageData2['url']; ?>"
                                                                alt="image"
                                                                style="width: 100%; height: 100%; object-fit: cover;" />
                                                        <?php endif; ?>
                                                    </div>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <?php echo $imageData1['description']; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php echo $imageData2 ? $imageData2['description'] : ''; ?>
                                        </td>
                                    </tr>
                                    <?php
                                endfor;
                        ...
                        <table class="table table-bordered border-gray-800 gy-4 gs-4">
                            <tbody>
                                ...
                                for ($i = 0; $i < $rowCount; $i += 2):
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        style="height: 300px; width: 300px;">
                                                        <img class="image-fit" src="<?php echo $imageData3['url']; ?>"
                                                            alt="image"
                                                            style="width: 100%; height: 100%; object-fit: cover;" />
                                                    </div>
                                                    <!--end::Input-->
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        style="height: 300px; width: 300px;">
                                                        <?php if ($imageData4): ?>
                                                            <img class="image-fit" src="<?php echo $imageData4['url']; ?>"
                                                                alt="image"
                                                                style="width: 100%; height: 100%; object-fit: cover;" />
                                                        <?php endif; ?>
                                                    </div>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <?php echo $imageData3['description']; ?>
                                        </td>
                                        <td class="text-center">
                                            <?php echo $imageData4 ? $imageData4['description'] : ''; ?>
                                        </td>
                                    </tr>
                                    <?php
                                endfor;
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        style="height: 300px; width: 300px;">
                                                        <img class="image-fit" src="<?php echo $imageData5['url']; ?>"
                                                            alt="image"
                                                            style="width: 100%; height: 100%; object-fit: cover;" />
                                                    </div>
                                                    <!--end::Input-->
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="position-relative d-flex align-items-center"
                                                        style="height: 300px; width: 300px;">
                                                        <?php if ($imageData6): ?>
                                                            <img class="image-fit" src="<?php echo $imageData6['url']; ?>"
                                                                alt="image"
                                                                style="width: 100%; height: 100%; object-fit: cover;" />
                                                        <?php endif; ?>
                                                    </div>
    ...
    <div class="flex-lg-auto min-w-lg-350px">
        <!--begin::Card-->
        <?php
        echo '<div class="card" data-kt-sticky="true" data-kt-sticky-name="report-asb" data-kt-sticky-offset="{default: false, lg: \'350px\'}" data-kt-sticky-width="{lg: \'250px\', lg: \'350px\'}" data-kt-sticky-left="auto" data-kt-sticky-top="10px" data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
            <!--begin::Card body-->
            <div class="card-body p-10">
                <!--begin::Actions-->
                <div class="mb-0">
                    <div class="d-flex">
                        <button type="button" class="btn btn-light-primary btn-active-primary me-8 w-50" onclick="window.location.href=`/surveys/site/reportAsbEdit/' . $systemId . '`">
                            <i class="fad fa-pen-to-square fs-4"></i>
                            <span class="d-none d-md-inline">Kemaskini</span>
                        </button>
                        <button type="button" id="submit-button" class="btn btn-primary">
                            <span><i class="fad fa-file-circle-check fs-4"></i> Semak</span>
                        </button>
                    </div>
                </div>
                <!--end::Actions-->
