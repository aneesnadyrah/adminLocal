...
$data = DetailsV1::getContactDetails($systemId); 
        ...
        $ofc = <<<officer
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width:250px;">
                            <p style="margin: 0.5rem 0 0 1rem">$recordNumber.4 NO TELEFON :</p>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width:250px;">
                            <p style="margin: 0.5rem 0 0 1rem">$recordNumber.5 ALAMAT EMEL :</p>
                        </td>
                        <td>
