...
$data = DetailsV1::getProjectDetails($systemId); 
$provider = General::getProvider($data->provider_id);
$road = DetailsV1::getRoadDetails($systemId); 
?>
            ...
            <table style="border-collapse: collapse;">
                <thead>
                    <tr style="border: 1px solid;">
                        ...
                        <td style="width: 10%; text-align: center; border: 1px solid;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <p style="margin: 0.5rem 0 0 0; border-bottom: 2px dotted"><?php echo $data->project_title ?></p>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td style="width:275px;">
                        <p style="margin: 0.5rem 0 0 1rem">1.2 KOS PROJEK KOREKGALI UTILITI (RM) :</p>
                    </td>
                    <td>
            ...
            <tbody>
                <tr>
                    <td style="width:250px;">
                        <p style="margin: 0.5rem 0 0 1rem">1.3 JANGKAAN TARIKH MULA KERJA :</p>
                    </td>
                    <td>
                        <p style="margin: 0.5rem 0 0 0; border-bottom: 2px dotted"></p>
                    </td>
                </tr>
                <tr>
                    <td style="width:250px;">
                        <p style="margin: 0.5rem 0 0 1rem">1.4 JANGKAAN TARIKH TAMAT KERJA :</p>
                    </td>
                    <td>
                        <p style="margin: 0.5rem 0 0 0; border-bottom: 2px dotted"></p>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <p style="margin: 0.5rem 0 0 0; border-bottom: 2px dotted"><?php echo $data->application_code ?></p>
                    </td>
                </tr>
                <tr>
                    <td style="width:250px;">
