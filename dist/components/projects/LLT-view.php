...
<div class="letter">
    <section class="sheet padding-10mm main-section" id="mainSection1">
        <div style="margin-bottom: 1rem; ">
            <table style="border-collapse: collapse;">
                <thead>
                    <tr style="border: 1px solid;">
                        <td rowspan="2" style="width: 10%; text-align: center; border: 1px solid;">
                            <img style="display: block; width: 150px; margin: auto; padding: 5px;" src="assets/media/logos/<?php echo $tenant ?>-default.svg">
                        </td>
                        <td>
                ...
                <tr>
                    <td class="py-1 pt-2 px-2" style="width:1%;">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" value="" <?php if ($currentReport['overlap_status'] === 0) {
                                                                                            echo '';
                    ...
                    <td class="py-1 pt-2 px-2" style="width:1%;">
                        <div class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" value="" <?php if ($currentReport['amend_status'] === 0) {
                                                                                            echo '';
        ...
        <div class="card card-flush pt-3 mb-3 mt-7 " id="map" style="width: 100%; height: 400px;"></div>
        <!-- </section>
            ...
            <tbody style="border:1px solid black;">
                ...
                for ($i = 0; $i < $count; $i += 2) {
                    ...
                    if (($i + 1) < $count) {
                        ...
                        $highlightClass2 = ($reviewColPic[$i]["amend"] && isset($_GET['hl']) ? ' bg-warning' : '');
                    ...
                    echo '
                                    ...
                                    <div class="position-relative d-flex align-items-center" >
                                        <div class="col-md-12 ' . $uniqueClass1 . ' report-review-pic">
                                            ...
                                            <p class="text-gray-600 fw-semibold fs-6'.$highlightClass1.'" style="text-align: justify;text-align-last: center;padding-left: 5px;padding-right: 5px;padding-top:5px;">' . $desc1 . '</p>
                                        </div>
                                        </div>
                                    </td>';
                                    ...
                                    <td class="p-2" style="width:50%">
                                        <div class="position-relative d-flex align-items-center" >
                                            <div class="col-md-12 ' . $uniqueClass2 . ' report-review-pic">
                                                ...
                                                <p class="text-gray-600 fw-semibold fs-6'.$highlightClass2.'" style="text-align: justify;text-align-last: center;padding-left: 5px;padding-right: 5px;padding-top:5px;">' . $desc2 . '</p>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>';
        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="height:120px;text-align: center;vertical-align: middle;">
                        <img class="report-approval-sign" style="max-height:120px; max-width:80%;" data-report-signature="signature-img" src="<?php echo $authoritySignature[0]['signature']; ?>" alt="Image">
                    ...
                    <td class="p-2">
                        <table>
                            <tr>
                                <td style="vertical-align: top;width:20%;">Nama</td>
                                <td style="vertical-align: top;width:1%;">: </td>
                                <td class="px-2 pb-1"><?php echo $authoritySignature[0]['full_name']; ?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;width:20%;">Jawatan</td>
                                <td style="vertical-align: top;width:1%;">: </td>
                                <td class="px-2 pb-1"><?php echo $authoritySignature[0]['position']; ?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;width:20%;">Tarikh</td>
                                <td style="vertical-align: top;width:1%;">: </td>
                                <td class="px-2 pb-1"><?php echo Report::convertDateToMalay($authoritySignature[0]['signed_timestamp']); ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<section class="sheet padding-10mm main-section" id="mainSection2">
        <div style="margin-bottom: 1rem; ">
            <table style="border-collapse: collapse;">
                <thead>
                    <tr>
