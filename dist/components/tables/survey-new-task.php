...
<div class="card card-flush">
    ...
    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
        ...
        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <div class="w-100 mw-150px">
                ...
                $url = $system->App->url."/api/lists/priority";
                ...
                // foreach ($data as $row) {
                //     echo '<option value="' . $row['ms_status'] . '">' . $row['ms_status'] . '</option>';
                // }
                foreach ($data as $row) {
    ...
    <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="survey-task">
            <!--begin::Table head-->
            <thead>
                <!--begin::Table row-->
