 ...
 <div class="card card-flush">
         ...
         <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
             ...
             <div class="w-100 mw-150px">
                 ...
                 <?php
                    ...
                    $url = 'https://'.$hostName.'/v1/lists/status.php';
                    ...
                    foreach ($data as $row) {
                        echo '<option value="' . $row['id'] . '">' . $row['flow_name'] . '</option>';
                    }
     ...
     <div class="card-body pt-0">
         <!--begin::Table-->
         <table class="table align-middle table-row-dashed fs-6 gy-5" id="work-order">
             <!--begin::Table head-->
             <thead>
                 <!--begin::Table row-->
