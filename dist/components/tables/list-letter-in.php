 ...
 <div class="card card-flush">
     ...
     <div class="card-header align-items-center py-5 gap-2 gap-md-5">
         ...
         <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
             ...
             <div class="w-100 mw-150px">
                 <!--begin::Select2-->
                 <?php
                    echo '<select class="form-select form-select-solid" data-control="select2" data-placeholder="Status" data-table-filter="status-letter">';
                    echo '<option value="all">Semua</option>';
                    echo '<option value="0">Baru</option>';
                    echo '<option value="1">Dalam Proses</option>';
             ...
             <!--begin::Add Letter In-->
            <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_add_letter_in_modal">
                <i class="fad fa-file-plus fs-2"></i>Surat</button>
             <!--end::Add Letter In-->
         </div>
         <!--end::Card toolbar-->
     </div>
     ...
     <div class="card-body pt-0">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="list-letter-in">
            <!--begin::Table head-->
            <thead>
                <!--begin::Table row-->
                <tr class="text-center text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    <th>Tarikh Surat Diterima</th>
