<?php 
$systemId = $_GET['sid'];
$dataAttach = wayleaveAmendments::getDataAttachmentTP($systemId);
?>
<!--begin::attachment info-->
<div class="accordion pt-1 mb-3 mb-xl-8" id="accordionAttach">
    <div class="card">
        <div class="card-header pt-6" id="headingOne" data-bs-toggle="collapse" data-bs-target="#collapseAttach" aria-expanded="false" aria-controls="collapseOne">
            <!-- <div class="mt-2"> -->
            <h2 class="fw-bold">Lampiran Awal Pemohon</h2>
            <span class="icon">&#9654;</span> <!-- Arrow icon -->
            <!-- </div> -->
        </div>
        <div class="separator separator-dashed"></div>
        <div id="collapseAttach" class="collapse" aria-labelledby="headingOne" data-bs-parent="#accordionAttach">
            <div class="card-body">
                <!--begin::Section-->
...
<div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-header">
        ...
        <div class="card-title">
            <h2 class="fw-bold">Lampiran Selepas Pindaan</h2>
        </div>
        <!--begin::Card title-->
    </div>
    <!--end::Card header-->
    ...
    <div class="card-body">
        ...
        <div class="mb-0 table-responsive">
            ...
            <table id="kt_file_manager_list" data-kt-filemanager-table="files"
                ...
                <?php
                    ...
                    <tbody class="fw-semibold text-gray-600">
                    HTML;
                        foreach ($dataAttach as $index => $attachment) {
                        $bytes = $attachment->size;
                        if ($bytes >= 1024 * 1024) {
                            $size = round($bytes / (1024 * 1024), 2) . ' MB';
                        } else {
                        ...
                        echo <<<TEMPLATE
                            <tr>
                                ...
                                <!--begin::Actions-->
                                <td class="text-end">
                                    <a href="#pdf-attach-amend-$index" data-fslightbox="lightbox-amend-tp" data-class="fslightbox-source"
                                        class="btn btn-icon btn-light btn-active-light-primary">
                                        <span class="fad fa-eye fs-5"></span>
                                    </a>
                                </td>
        ...
        foreach ($dataAttach as $index => $attachment) {
            echo <<<TEMPLATE
            <div style="display: none;">
                <div id="pdf-attach-amend-$index" style="height: 100vh; width: 95vw">
                    <iframe class="scroll w-100 h-100" src="/attachments/view?url=$attachment->url&mime=$attachment->mime_type ">
                    </iframe>
                </div>
            </div>
