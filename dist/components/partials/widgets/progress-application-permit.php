            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            ...
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/7.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                    ...
                    <div class="flex-grow-1">
                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">KUK/TM/03/23/03/A3</a>
                ...
                <!--end::Section-->
                <!--begin::Statistics-->
                <div class="d-flex align-items-center w-100 mw-100px">
                    <!--begin::Progress-->
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs025.svg-->
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/2.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                    ...
                    <!--begin::Section-->
                    <div class="flex-grow-1">
                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">KUK/DIGI/03/23/04/A3</a>
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs025.svg-->
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/5.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                    ...
                    <!--begin::Section-->
                    <div class="flex-grow-1">
                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">KUK/TNBB/1/23/63/A3</a>
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs025.svg-->
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/6.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                    ...
                    <!--begin::Section-->
                    <div class="flex-grow-1">
                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">KUK/PAP/JT/5/22/21/A1</a>
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs025.svg-->
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/8.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
                    ...
                    <!--begin::Section-->
                    <div class="flex-grow-1">
                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">KUK/GAS/03/23/06/A3</a>
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="symbol symbol-40px me-3">
                        <span class="symbol-label bg-light">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs025.svg-->
                            <span class="svg-icon svg-icon-2x svg-icon-info">
                                <img src="assets/media/provider/10.webp" class="w-40px" alt="" />
                            </span>
                            <!--end::Svg Icon-->
                        </span>
                    </div>
