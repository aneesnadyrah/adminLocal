<div id="kt_sliders_widget_3_slider" class="card card-flush carousel slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="card-header pt-5 mb-5">
        ...
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-gray-400 mt-1 fw-semibold fs-7">Purata
                <span class="badge badge-light-success align-self-center px-2">75%</span>
            permit yang telah selesai</span>
        </h3>
        <!--end::Title-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body p-0">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item show active">
                <!--begin::Title-->
                <span class="text-gray-800 fw-bold fs-4 mb-3 px-8">Peratusan Selesai</span>
                <!--end::Title-->
                <!--begin::Statistics-->
                <div class="d-flex align-items-center w-100 px-8">
                    ...
                    <!--end::Progress-->
                    <!--begin::Value-->
                    <span class="text-gray-400 fw-bold fs-4">75%</span>
                    <!--end::Value-->
                </div>
                <!--end::Statistics-->
            </div>
