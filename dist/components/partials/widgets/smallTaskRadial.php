...
<div class="card card-flush h-md-50 mb-5 mb-xl-10 hover-elevate-up cursor-pointer">
    ...
    <div class="card-header pt-5">
        ...
        <div class="card-title d-flex flex-column w-100">
            ...
            <div class="d-flex align-items-center w-100">
                <!--begin::Currency-->
                <span class="fad user text-primary fs-3x me-4"></span>
                <!--end::Currency-->
                <!--begin::Amount test::25-->
                <span name="head-total" class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">20</span>
                <!--end::Amount-->
                <!--begin::Badge-->
            ...
            <span name="head-title" class="text-gray-700 pt-1 fw-semibold fs-3 pt-3">Permohonan Baru</span>
            <!--end::Subtitle-->
        </div>
        <!--end::Title-->
    </div>
    ...
    <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
        ...
        <div class="d-flex flex-center me-5 pt-2">
            <div name="task-overview-head" style="min-width: 70px; min-height: 70px" data-kt-size="70" data-kt-line="11" data-kt-progress-color="warning"></div>
        </div>
        <!--end::Chart-->
        <!--begin::Labels-->
        <div class="d-flex flex-column content-justify-center flex-row-fluid">
            ...
            <div class="d-flex fw-semibold align-items-center">
                ...
                <!--end::Label-->
                <!--begin::Stats-->
                <div name="count-success" class="fw-bolder text-gray-700 text-xxl-end">24</div>
                <!--end::Stats-->
            </div>
            <!--end::Label-->
            <!--begin::Label-->
