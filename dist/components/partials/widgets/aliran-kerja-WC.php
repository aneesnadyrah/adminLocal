<?php  
    $count = ProjectDetails::countWorkFlow($detail['system_id'], 6)[0]; 
    $data = ProjectDetails::getWorkFlow($detail['system_id'], 6); 
?>
...
<div class="col-md-4 col-lg-12 col-xl-4">
    ...
    <div class="mb-2">
        <div class="d-flex flex-stack">
            <div class="fw-bold fs-4">Pemulangan Wang Cagaran
