<?php   
    ...
    $username = $_SESSION['username']; 
        ...
        echo <<<TEMPLATE
            ...
            <div class="card card-flush card-stretch slide mb-10 placeholder-wave rounded" data-bs-interval="5500">
                <!--begin::Header-->
                <div class="card-header pt-5 placeholder bg-secondary-active">
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body py-4 placeholder bg-secondary-active">
        ...
        //                 <div class="m-0">
        //                     <!--begin::Subtitle-->
        //                     <h4 class="fw-bold text-gray-800 mb-4">Kumpulan A</h4>
        //                     <!--end::Subtitle-->
        ...
        //                 <!--end::Symbol-->
        //                 <!--begin::Section-->
        //                 <div class="d-flex align-items-center flex-row-fluid flex-wrap placeholder-wave rounder">
        //                     <!--begin:Author-->
        ...
        //                     <!--begin::Actions-->
        //                     <div class="flex-grow-1 me-2">
        //                         <span class="d-flex align-items-end ms-10  placeholder">$data->clockIn</span>
        //                     </div>
        //                     <!--begin::Actions-->
        //                 </div>
        //                 <!--end::Section-->
        ...
        //                     <!--begin::Actions-->
        //                     <div class="flex-grow-1 me-2">
        //                         <span class="d-flex align-items-end ms-10  placeholder">$data->clockOut</span>
        //                     </div>
        //                     <!--begin::Actions-->
        //                 </div>
        //                 <!--end::Section-->
        ...
        //                     <!--begin::Actions-->
        //                     <div class="flex-grow-1 me-2">
        //                         <span class="d-flex fw-bold align-items-end ms-15">$data->count</span>
        //                     </div>
        //                     <!--begin::Actions-->
        //                 </div>
        //                 <!--end::Section-->
        ...
        //                         <span class="badge badge-light-success align-items-end ms-20">$data->status</span>
        //                     </div>
        //                     <!--begin::Actions-->
        //                 </div>
        //                 <!--end::Section-->
