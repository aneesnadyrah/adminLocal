    ...
    <div class="card card-flush h-500px">
            ...
            <div class="card-toolbar">
                ...
                <ul class="nav nav-pills nav-pills-custom">
                    ...
                    <li class="nav-item me-3 me-lg-6">
                        <!--begin::Link-->
                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden active" data-bs-toggle="pill" href="#tab-AK">
                            <!--begin::Title-->
                            <span class="nav-text text-gray-800 fw-bold fs-6 lh-1 my-4">AK</span>
                            <!--end::Title-->
                            <!--begin::Bullet-->
                    ...
                    <li class="nav-item mb-3 me-3 me-lg-6">
                        <!--begin::Link-->
                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-warning flex-column overflow-hidden" data-bs-toggle="pill" href="#tab-SH">
                            <!--begin::Title-->
                            <span class="nav-text text-gray-800 fw-bold fs-6 lh-1 my-4">SH</span>
                            <!--end::Title-->
                            <!--begin::Bullet-->
                    ...
                    <li class="nav-item mb-3 me-3 me-lg-6">
                        <!--begin::Link-->
                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden" data-bs-toggle="pill" href="#tab-INV">
                            <!--begin::Title-->
                            <span class="nav-text text-gray-800 fw-bold fs-6 lh-1 my-4">INV</span>
                            <!--end::Title-->
                            <!--begin::Bullet-->
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <!--begin::Tap pane-->
                <div class="tab-pane fade active show" id="tab-AK">
                            ...
                            <tbody>
                                ...
                                if (empty(Dashboard::accountWOWidget(7))) {
                                    ...
                                    <div class="fw-semibold py-10 text-center">
                                        <div class="text-gray-600 fs-3 mb-2">Tiada Tugasan Terkini</div>
                                        <div class="text-muted fs-6">Anda tiada Tugasan Terkini untuk minggu ini...</div>
                                    </div>
                ...
                <!--end::Tap pane-->
                <!--begin::Tap pane-->
                <div class="tab-pane fade" id="tab-SH">
                    <!--begin::Table container-->
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
