                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Muatnaik Baki Invois Bayaran Terima</h3>
                                ...
                                <form class="modal-body" novalidate="novalidate" id="form-' . $id['StatusID']. $id['ID'] . '">
                                        ...
                                        <div class="dropzone border-' . $id['StatusColor'] . ' bg-light-' . $id['StatusColor'] . '" id="add-attachment-' . $id['StatusID']. $id['ID'] . '">
                                            ...
                                            <div class= "dz-message needsclick">
                                                ...
                                                <div class="ms-4">
                                                    ...
                                                    <span class="fs-7 fw-semibold text-gray-400">Sila Pilih Dokumen Baki Invois Bayaran Terima</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7 required mb-5"><em>Pastikan dokumen RCPP telah disatukan dalam bentuk format pdf</em></div>
                                    <!--end::Description-->
                                    <div class="col-12 fs-6 fv-row mb-5">
                                        <label class="required form-label mb-2">Kaedah Pembayaran</label>
                                        <select class="form-select form-select-solid fs-6" data-control="select2" data-placeholder="Status" data-hide-search="true" name="payment_method_2">
                                    ...
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label">Jumlah Amaun Baki Bayaran Invois (RM)</label>
                                        <input type="text" name="total-inv-pay-2" class="form-control form-control-solid" placeholder="Sila Isi Amaun Baki Bayaran Invois"/>
                                    </div>
                                    <!--begin::Submit button-->
