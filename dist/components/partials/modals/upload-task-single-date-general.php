...
echo '<!--begin::Modal-->
        <div data-check="single-date" class="modal fade" data-bs-backdrop="static" tabindex="-1" id="action-' . $row['StatusID'] . $row['ID'] . '">
                    ...
                    <form class="modal-body" novalidate="novalidate" id="form-' . $row['StatusID'] . $row['ID'] . '">
                        ...
                        <div class="fv-row mb-2">
                            ...
                            <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['StatusID'] . $row['ID'] . '">
                                ...
                                <input type="text" id="label-' . $row['StatusID'] . $row['ID'] . '" name="label-input" value="' . $label['dt'] . '" hidden>
                            </div>
                            <!--end::Dropzone-->
                        </div>
                        <!--end::Input group-->
