...
// var_dump($Modal->TaskDoubleDate());

// foreach ($Modal->TaskDoubleDate() as $row) {

echo '<!--begin::Modal-->
        <div data-check="double-date" class="modal fade" data-bs-backdrop="static" tabindex="-1" id="action-' . $row['authority_status'] . $row['id'] . '">
