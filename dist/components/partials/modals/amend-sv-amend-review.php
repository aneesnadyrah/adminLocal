<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="modal-amend-sv-review" style="overflow-y: scroll !important; ">
            ...
            <form id="amend_sv_amendReview_form" action="#" method="POST">
                ...
                <div class="modal-body">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body text-center">Pinda Permohonan ini?</h4>
                ...
                <div class="modal-footer py-3">
                    ...
                    <button type="submit" id="amend_sv_amendReview_submit" class="btn btn-primary me-3">Hantar</button>
                </div>
                <!--end::Modal footer-->
