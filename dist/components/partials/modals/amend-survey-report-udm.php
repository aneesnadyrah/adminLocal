<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="modal-amend-survey-udm" style="overflow-y: scroll !important; ">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <form id='form_amend_report_udm'>
                <input type="text" name="amend-survey-report-udm" value="1" hidden />
                ...
                <div class="modal-footer py-3">
                    ...
                    <button type="submit" class="btn btn-primary" id="amend_report_udm_submit">
