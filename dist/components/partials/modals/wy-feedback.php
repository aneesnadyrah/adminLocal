...
if($appsTitle == 'UCIDOS' || $appsTitle == 'KUDRAT') {
    ...
    foreach ($wayleave_mkil as $row) {
        ...
        <!-- Add this HTML structure to your page for the modal -->
        <div class="modal fade" id="pdfModal" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="pdfModalLabel">Surat Kelulusan Izin Lalu</h3>
                        <button type="button" class="btn btn-icon btn-sm btn-active-light-success ms-2" data-bs-dismiss="modal" aria-label="Close">
                            <i class="fad fa-xmark fs-2"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <!-- This is where the iframe with the PDF will be displayed -->
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-success" data-bs-dismiss="modal">Tutup</button>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="flex-column" data-kt-stepper-element="content">
                                            ...
                                            <div class="mb-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <?php
                                                if($row['Tags'] == 'Sistem') { ?>
                                                    <input type="text" class="form-control form-control-solid" name="up_pemohon" value="-" />
                                                <?php
                                                } else { ?>
                                            ...
                                            <div class="mb-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <?php
                                                if($row['Tags'] == 'Sistem') { ?>
                                                    <input type="text" class="form-control form-control-solid" name="addr_client_1" placeholder="Alamat Pertama" value="-" />
                                                    <input type="text" class="form-control form-control-solid" name="addr_client_2" placeholder="Alamat Kedua" value="-" />
                                                    <!--begin::Input group-->
                                                    <div class="row fv-row fv-plugins-icon-container mt-3">
                                                        <div class="col-4">
                                                            <input type="text" class="form-control form-control-solid" id="postcode_client" name="postcode_client" placeholder="Poskod" value="-" />
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" class="form-control form-control-solid" id="city_client" name="city_client" placeholder="Bandar" value="-" />
                                                        </div>
                                                        <div class="col-4">
                                                        <input type="text" class="form-control form-control-solid" id="state_client" name="state_client" placeholder="Negeri" value="-" />
                                                        </div>
                                                    </div>
                                                    <!--end::Input group-->
                                                <?php
                                                    ...
                                                    <div data-repeater-item class="border border-gray-300 p-5 mb-5">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="name_r" class="form-control mb-2 mb-md-0" />
                                                            </div>
                                                            <div class="col-md-12 mt-3">
                                                                <label class="form-label">Alamat:</label>
                                                                <input type="text" name="addr_1_r" class="form-control mb-2" />
                                                                <input type="text" name="addr_2_r" class="form-control mb-2" />
                                                                <!--begin::Input group-->
                                                                <div class="row fv-row fv-plugins-icon-container mt-3">
                                                                    <div class="col-4">
