        ...
        <div class="modal fade" data-bs-backdrop="static" tabindex="-1" id="action-' . $row['subMappingID'] . $row['MappingID']. $row['ID'] .'">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="modal-body" novalidate="novalidate" id="form-' . $row['subMappingID'] . $row['MappingID']. $row['ID'] .'">
                        <!--begin::Input group-->
                        <div class="fv-row mb-2">
                            <!--begin::Dropzone-->
                            <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['subMappingID'] . $row['MappingID']. $row['ID'] .'">
                                <!--begin::Message-->
                                ...
                                <input type="text" id="sid-' . $row['subMappingID'] . $row['MappingID']. $row['ID'] .'" name="system-id" value="' . $row['SysID'] . '" hidden>
                                <input type="text" id="f-' . $row['subMappingID'] . $row['MappingID']. $row['ID'] .'" name="folder" value="' . $row['fileId'] . '" hidden>
                            </div>
                            <!--end::Dropzone-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-5 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">' . $row['dateTitle'] . '</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="' . $row['dt'] . '-' . $row['fileId'] . '" type="text" data-control="flatpickr"">
                                <!--end::Datepicker-->
                            </div>
                            <!--end::Input-->
                        </div>
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" name="notes-' . $row['fileId'] . '" placeholder="Catatan"></textarea>
                        </div>
                        <!--end::Description-->
                        <!--begin::Submit button-->
