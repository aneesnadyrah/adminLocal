                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Muatnaik Arahan Kerja Operasi</h3>
                                    ...
                                    <form class="modal-body" novalidate="novalidate" id="form-' . $id['StatusID'] . $id['ID'] . '">
                                        ...
                                        <div class="fv-row mb-2">
                                            ...
                                            <div class="dropzone border-' . $id['StatusColor'] . ' bg-light-' . $id['StatusColor'] . '" id="add-attachment-' . $id['StatusID'] . $id['ID'] . '">
                                                ...
                                                <input type="text" id="f-' . $id['StatusID'] . $id['ID'] . '" name="folder" value="AKO" hidden>
                                            </div>
                                            <!--end::Dropzone-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="total-woo" class="form-control form-control-solid" placeholder="Sila Isi Amaun Arahan Kerja"/>
                                        </div>
                                        <!--end::Description-->
                                        <!--begin::Submit button-->
