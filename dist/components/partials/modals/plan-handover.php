                    ...
                    <div class="modal-content">
                        ...
                        <form class="modal-body" novalidate="novalidate" id="formSurvey-' . $id['subMappingID']  . $id['MappingID'] . $id['ID'] . '">
                            ...
                            <div class="form-floating mb-7 fv-row">
                                <input class="form-control form-control-solid" id="date-picker-' . $id['subMappingID']  . $id['MappingID'] . $id['ID'] . '" name="handover" placeholder="Tarikh" readonly />
                            ...
                            <!--begin::Input group-->
                            <div class="form-floating mb-7 fv-row">
                                <input type="text" class="form-control form-control-solid" id="handover-remark" name="handover-remark" placeholder="Catatan"/>
                                <label for="handover-remark">Catatan</label>
