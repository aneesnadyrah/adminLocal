                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Muatnaik Baki Invois</h3>
                                        ...
                                        <div class="dropzone border-' . $id['StatusColor'] . ' bg-light-' . $id['StatusColor'] . '" id="add-attachment-' . $id['StatusID']. $id['ID'] . '">
                                            ...
                                            <div class= "dz-message needsclick">
                                                ...
                                                <div class="ms-4">
                                                    ...
                                                    <span class="fs-7 fw-semibold text-gray-400">Sila Pilih Dokumen Invois</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <input type="text" id="sid-' . $id['StatusID']. $id['ID'] . '" name="system-id" value="' . $id['SysID'] . '" hidden>
                                            <input type="text" id="f-' . $id['StatusID']. $id['ID'] . '" name="folder" value="ICPP" hidden>
                                        </div>
                                        <!--end::Dropzone-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7 required mb-5"><em>Pastikan dokumen Invois telah disatukan dalam bentuk format pdf</em></div>
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label">Jumlah Amaun Baki Invois (RM)</label>
                                        <input type="text" name="total-inv-2" class="form-control form-control-solid" placeholder="Sila Isi Amaun Baki Invois"/>
                                    </div>
                                    <!--end::Description-->
                                    <!--begin::Submit button-->
