                    ...
                    <form class="modal-body" novalidate="novalidate" id="form-' . $row['StatusID'] . $row['ID'] . '">
                        ...
                        <div class="fv-row mb-2">
                            ...
                            <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['StatusID'] . $row['ID'] . '">
                                ...
                                <input type="text" id="f-' . $row['StatusID'] . $row['ID'] . '" name="folder" value="PHDD" hidden>
                            </div>
                            <!--end::Dropzone-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" name="notes-PHDD" placeholder="Catatan"></textarea>
                        </div>
                        <!--end::Description-->
                        <!--begin::Submit button-->
