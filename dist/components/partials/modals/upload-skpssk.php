        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Surat Kelulusan Permohonan Sijil Siap Kerja</h3>
                ...
                <form class="modal-body" novalidate="novalidate" id="form-' . $row['authority_status']. $row['id'] . '">
                    ...
                    <div class="fv-row mb-2">
                        ...
                        <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['authority_status']. $row['id'] . '">
                            ...
                            <input type="text" id="f-' . $row['authority_status']. $row['id'] . '" name="folder" value="SKPSSK" hidden>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-5 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="dt_cpc_dlp_start" type="text" data-control="flatpickr">
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
                        ...
                        <div class="col">
                            <div class="mb-5 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">Tarikh Tamat</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div class="position-relative d-flex align-items-center">
                                    <!--begin::Icon-->
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="dt_cpc_dlp_end" type="text" data-control="flatpickr">
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-5 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">Tarikh kelulusan</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <div class="position-relative d-flex align-items-center">
                                    <!--begin::Icon-->
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="dt_cpc_appv_ltr" type="text" data-control="flatpickr">
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
                        ...
                        <div class="col">
                            <div class="mb-5 fv-row">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Datepicker-->
                                    <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="dt_cpc_appc_recv" type="text" data-control="flatpickr">
                                    <!--end::Datepicker-->
                                </div>
                                <!--end::Input-->
                            </div>
