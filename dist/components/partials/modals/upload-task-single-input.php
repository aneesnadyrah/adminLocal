                    ...
                    <form class="modal-body" novalidate="novalidate" id="form-' . $row['authority_status']. $row['id'] . '">
                        ...
                        <div class="fv-row mb-2">
                            ...
                            <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['authority_status']. $row['id'] . '">
                                ...
                                <input type="text" id="f-' . $row['authority_status']. $row['id'] . '" name="folder" value="' . $fileId . '" hidden>
                                <input type="text" id="aid-' . $row['authority_status'] . $row['id'] . '" name="authority-id" value="' . $row['authority_id'] . '" hidden>
                                <input type="text" id="label-' . $row['authority_status'] . $row['id'] . '" name="label-input" value="' . $label['dt'] . '" hidden>
                                <input type="text" id="label2-' . $row['authority_status'] . $row['id'] . '" name="label-input2" value="' . $label['typeId'] . '" hidden>
                            </div>
                            <!--end::Dropzone-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-5 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">' . $label['dateTitle'] . '</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <div class="position-relative d-flex align-items-center">
                                        ...
                                        <input class="form-control form-control-solid ps-12 flatpickr-input" placeholder="Sila Pilih Tarikh" name="' . $label['dt'] . '-' . $fileId . '" type="text" data-control="flatpickr">
                                        <!--end::Datepicker-->
                                    </div>
                                    <!--end::Input-->
                                </div>
                            ...
                            <div class="col">
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">' . $label['inputTitle'] . '</label>
                                    <input type="' . $label['type'] . '" class="form-control form-control-solid" name="' . $label['typeId'] . '-' . $fileId . '2" placeholder="' . $label['inputTitle'] . '"></input>
                                </div>
                            </div>
                        </div>
