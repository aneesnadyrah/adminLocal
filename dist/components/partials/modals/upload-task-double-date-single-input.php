                    ...
                    <form class="modal-body" novalidate="novalidate" id="form-' . $row['authority_status']. $row['id'] . '">
                        ...
                        <div class="fv-row mb-2">
                            ...
                            <div class="dropzone border-' . $row['StatusColor'] . ' bg-light-' . $row['StatusColor'] . '" id="add-attachment-' . $row['authority_status']. $row['id'] . '">
                                ...
                                <input type="text" id="label-' . $row['authority_status'] . $row['id'] . '" name="label-input" value="' . $label['dt1'] . '" hidden>
                                <input type="text" id="label2-' . $row['authority_status'] . $row['id'] . '" name="label-input2" value="' . $label['dt2'] . '" hidden>
                                <input type="text" id="label3-' . $row['authority_status'] . $row['id'] . '" name="label-input3" value="' . $label['typeId'] . '" hidden>
                            </div>
                            <!--end::Dropzone-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <input type="' . $label['type'] . '" class="form-control form-control-solid" name="' . $label['typeId'] . '-' . $fileId . '3" placeholder="' . $label['inputTitle'] . '"></input>
                        </div>
