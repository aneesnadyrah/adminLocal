                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title">Muatnaik Invois</h3>
                                ...
                                <form class="modal-body" novalidate="novalidate" id="form-' . $id['StatusID']. $id['ID'] . '">
                                    ...
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label">Jumlah Amaun Invois (RM)</label>
                                        <input type="text" name="total-inv" class="form-control form-control-solid" placeholder="Sila Isi Amaun Invois"/>
                                    </div>
                                    <!--end::Description-->
                                    <!--begin::Submit button-->
