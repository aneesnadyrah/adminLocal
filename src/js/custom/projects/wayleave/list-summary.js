...
var SummaryList = (function () {
  ...
  var initDatatable = function () {
    ...
    datatable = $(table).DataTable({
      ajax: apps + "/api/wayleave/summary/list",
      columns: [
        { data: "reference_no" },
        { data: "Provider" },
        { data: "District" },
        ...
        },
        {
          ...
          render: function (index, type, key, meta) {
            let render;
              ...
              <a href="projects/wayleave/summary/`+ key['system_id'] + `" class="btn btn-icon btn-light-` + key["SummaryStatusColor"] + `">
                <i class="fad fa-` + key["SummaryStatusIcon"] + ` fs-2"></i>
              </a>
            </div>`
  ...
  return {
    init: function () {
      table = document.querySelector("#list-summary");
