var reviewSummary = (function () {

    // let PageIDs = [];
    console.log("berjaya");

    $.ajax({
      url: apps + "/api/wayleave/summary/list",
      dataType: "json",
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        let ID = obj.id;
        let SummaryStatus = obj.summary_status;
        let systemId = obj.system_id;
        // let letterID = obj.LetterID;
        let PageID = SummaryStatus.toString() + ID.toString();
        console.log(PageID);
        ...
        if (SummaryStatus == '1') {
          ...
          // document.addEventListener('DOMContentLoaded', function() {
            ...
            let formReview = "#form-project-summary-" + PageID;
          ...
          // try {
            if (sending) {
              sending.addEventListener("click", function (e) {
                ...
                Swal.fire({
                  title: "Hantar Ringkasan Projek yang dijana?",
                  ...
                  if (result.isConfirmed) {
                    ...
                    api.post(`wayleave/summary/tasking`, jsonData)
                      .then(response => {

                              sending.removeAttribute("data-kt-indicator");

                              Swal.fire({
                                text: "Ringkasan Projek telah berjaya dihantar untuk Disahkan!",
                                icon: "success",
                  ...
                  if (result.isConfirmed) {
                    ...
                    api.post(`wayleave/summary/tasking`, jsonData)
                      .then(response => {
                              ...
                              Swal.fire({
                                text: "Ringkasan Projek telah berjaya Disahkan!",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, maklum!",
                                customClass: {
                          ...
                          api.post(`bot/message`, jsonData2)
                            ...
                            Swal.fire({
                              ...
                              if (result.isConfirmed) {
                                ...
                                location.href = "/letters/list.php";
