...
// Class definition
var amendSurveyReport = (function () {
    var handleSubmit = () => {
        // Define variables
        let validator;

        // Get elements
        let form = document.getElementById('form_amend_report_udm');
        let submitButton = document.getElementById('amend_report_udm_submit');
