var modalSurat = (function () {

  let modalIDs = [];

  $.ajax({
    url: apps + "/api/letters/list",
    dataType: "json",
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      let ID = obj.ID;
      let letterStatusID = obj.LetterStatusID;
      let letterID = obj.LetterID;
      let modalID = statusID + ID + letterStatusID + letterID;
      let systemId = obj.SysID
      // console.log(modalID);

      // modalIDs.push(modalID); // push the modalID into the array
      ...
      if (letterStatusID == '1') {
        ...
        // document.addEventListener('DOMContentLoaded', function() {
          ...
          let send = "#send-button-" + modalID;
          let formReview = "#form-PIL-review-" + modalID;
        ...
        // try {
          if (sending) {
            sending.addEventListener("click", function (e) {
              ...
              Swal.fire({
                title: "Hantar Surat Permohonan Izin Lalu?",
                      ...
                      const formData2 = serializedArray2;
                        ...
                        api.post(`bot/message`, jsonData2)
                          .then(response => {
                            ...
                            Swal.fire({
                              text: "Surat Permohonan Izin Lalu telah berjaya dihantar untuk Disahkan!",
                              icon: "success",
        ...
        // });
          ...
          let stepperModal = "#kt_stepper_update_letter_PIL_" + modalID;
          // Stepper lement
        ...
        let selectName = "#approval-name-" + modalID;
        // let selectNames = document.querySelector(selectName);
        let selectPosition = "#approval-position-" + modalID;
        let officerName1 = "#officer-name1-" + modalID;
        let officerContact1 = "#officer-contact1-" + modalID;
        let officerName2 = "#officer-name2-" + modalID;
        let officerContact2 = "#officer-contact2-" + modalID;

        // $(selectNames).select2();
        // $(selectNames).val(null).trigger("change");
        // $(officerName1).select2();
        // $(officerName2).select2();
        ...
        $(document).ready(function () {
          ...
          let toogleBP = "#tanda-bagiPihak-" + modalID;
          let inputBP = "#bp-position-" + modalID;
        ...
        var startDate = "#date-start-" + modalID;
        var endDate = "#date-finish-" + modalID;
        ...
        let formUp = "#form-update-" + modalID;
        let formUpdate = document.querySelector(formUp);
        let submitUp = "#submit-update-" + modalID;
          ...
          validator.validate().then(function (status) {
            ...
            api.post(`letters/tasking`, jsonData)
                .then(response => {
                  ...
                  Swal.fire({
                    text: "Surat Permohonan Izin Lalu telah berjaya Dikemaskini!",
                    icon: "success",
                    buttonsStyling: false,
                    confirmButtonText: "Ok, maklum!",
                    customClass: {
                    ...
                    if (result.isConfirmed) {
                      ...
                      location.href = "/letters/PIL/" + response.systemId + "/" + response.letterId.id;
                    }
                  });
                })
                .catch(error => {
      ...
      } else if (letterStatusID == '2') {

        // document.addEventListener('DOMContentLoaded', function() {

        let approve = "#approve-button-" + modalID;
        ...
        // try {
          if (approving) {
            approving.addEventListener("click", function (e) {
              ...
              Swal.fire({
                title: "Sahkan Surat Permohonan Izin Lalu?",
                      ...
                      const formData2 = serializedArray2;
                        ...
                        api.post(`bot/message`, jsonData2)
                          .then(response => {
                            ...
                            Swal.fire({
                              text: "Surat Permohonan Izin Lalu telah berjaya Disahkan!",
                              icon: "success",
                              buttonsStyling: false,
                              confirmButtonText: "Ok, maklum!",
                              customClass: {
        ...
        let formCom = "#form-comment-letter-" + modalID;
        let formComment = document.querySelector(formCom);
        let SubmitCom = "#comment-letter-button-" + modalID;
      ...
      } else if (letterStatusID == '3') {


        let print = "#print-button-" + modalID;
        let formReview = "#form-PIL-review-" + modalID;
        ...
        if (toggleInput.checked) {
          ...
          // var modalBody = "#update-letter-" + modalID;
      ...
      // call your function and pass in the modalID
      // myFunction(modalID);
      // mySubmit(modalID);
      // }
    }

    // Access the modalIDs array here and perform further operations if needed
