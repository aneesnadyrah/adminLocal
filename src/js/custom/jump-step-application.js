...
var jumpStep = (function () {
    ...
    var handleSubmit = () => {
        ...
        // Get elements
        let form = document.getElementById('form_jump_step');
        let submitAction = document.getElementById('submit_jump_step');
            ...
            form,
            {
                fields: {
                    'notes': {
                        validators: {
                            notEmpty: {
                                message: 'Sila Isi Catatan Langkau Status Permohonan'
                            }
                        }
                    },
                },
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        api.post('projects/jumpstep', JSON.stringify(formData))
                        .then(response => {
